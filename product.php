                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="single-flex">
                            <div class="single-product-info product-info product-grid-v2 s-50">
                                ...
                                <div class="product-price">
                                    <span><?php echo "Rs: ".($price-$discount); ?></span>
                                </div>
                                <div class="availability">
                                    <p class="product-inventory"> <label>Availability : </label><span> <?php echo $quantity; ?></span></p>
                                </div>
                                
                                <div class="product-sku">
                                    <label>Product ID :</label><span> <?php echo $id; ?></span>
                                </div>
                                       ...
                                       <?php 
                                            if (isset($_SESSION['position'])) {
                                                if ($_SESSION['position']=='admin') {
                                                    echo '<a href="product_edit.php?id='.$id.'" class="btn-add-cart btn-amazon">Update Product </a>';
                                                }else{
                                                    echo '<a href="#" class="btn-add-cart btn-amazon">By on Infinity.com </a>';
                                                }
                                            }else{
                                                echo '<a href="#" class="btn-add-cart btn-amazon">By on Infinity.com </a>';
                                            }
                                ...
                                <div class="product-tags">
                                    <label>Tags :</label>
                                    <a href="accessorieshome.php?filter=<?php echo $tag; ?>"><?php echo $tag; ?></a>
                                </div>
                            </div>
